 ...
 * @description Navigation Menu component using Radix UI.
 * Provides accessible navigation menus with support for dropdown submenus,
 * viewport animations, and keyboard navigation.
 *
