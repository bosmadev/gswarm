 ...
 * Provides styled, accessible table elements with sorting and filtering support.
 *
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b border-border transition-colors hover:bg-bg-secondary/50 data-[state=selected]:bg-orange/10",
      className,
    )}
    {...props}
  />
